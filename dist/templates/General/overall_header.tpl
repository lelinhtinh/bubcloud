...
<head>
    ...
    {T_HEAD_STYLESHEET}
    {CSS}
    <link href="//cdn.rawgit.com/baivong/bubcloud/master/public/1.0.0/style.css" rel="stylesheet" type="text/css">
    ...
    <script src="//cdn.rawgit.com/baivong/bubcloud/master/public/1.0.0/bubcloud.header.js" type="text/javascript"></script>
    {HOSTING_JS}
