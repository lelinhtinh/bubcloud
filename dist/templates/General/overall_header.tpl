...
<head>
    ...
    {T_HEAD_STYLESHEET}
    {CSS}
    <link href="//cdn.rawgit.com/baivong/bubcloud/master/public/0.9.0/style.css" rel="stylesheet" type="text/css">
    ...
    <script src="//cdn.rawgit.com/baivong/bubcloud/master/public/0.9.0/bubcloud.top.js" type="text/javascript"></script>
    <script>
