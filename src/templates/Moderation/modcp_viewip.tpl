        ...
        <table class="ipbtable" cellspacing="0">
            ...
            <tbody>
                <tr>
                    ...
                    <td class="row1 text-right">[ <a href="{U_LOOKUP_IP}">{L_LOOKUP_IP}</a> ]</td>
                </tr>
            </tbody>
        </table>
        <table class="ipbtable" cellspacing="0">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="row1 text-right"><a title="{userrow.L_SEARCH_POSTS}" href="{userrow.U_SEARCHPOSTS}">{userrow.L_SEARCH}</a></td>
                </tr>
                <!-- END userrow -->
            </tbody>
        </table>
        <table class="ipbtable" cellspacing="0">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="row1 text-right">[ <a href="{iprow.U_LOOKUP_IP}">{L_LOOKUP_IP}</a> ]</td>
                </tr>
                <!-- END iprow -->
            </tbody>
        </table>
