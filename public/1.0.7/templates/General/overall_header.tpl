...
<head>
    ...
    {T_HEAD_STYLESHEET}
    {CSS}
    <link href="//unpkg.com/bubcloud@1.0.7/dist/style.css" rel="stylesheet" type="text/css">
    ...
    <script src="//unpkg.com/bubcloud@1.0.7/dist/bubcloud.header.js" type="text/javascript"></script>
    {HOSTING_JS}
