		...
		<div class="maincontent">
			<fieldset>
				<dl>
					...
					<dd class="dd-options">
						<label for="any">
							<input id="any" type="radio" name="search_terms" value="any" checked="checked" /> {L_SEARCH_ANY_TERMS}
						</label>
					</dd>
					<dd class="dd-options">
						<label for="all">
							<input id="all" type="radio" name="search_terms" value="all" /> {L_SEARCH_ALL_TERMS}
						</label>
					</dd>
					<!-- BEGIN TAGS -->
					<dd class="dd-options">
						<label for="rtags">
							<input id="rtags" type="checkbox" name="is_tag" value="true" /> {TAGS.L_SEARCH_TAGS}
						</label>
					</dd>
					<!-- END TAGS -->
				</dl>
		...
		<div class="maincontent">
			<fieldset class="col-2">
				<dl>
					...
					<dd>
						<select name="search_where">{S_FORUM_OPTIONS}</select>
					</dd>
				</dl>
				<dl>
					<dt>
						<label>{L_SEARCH_PREVIOUS}:</label>
					</dt>
					<dd>
				...
				<dl>
					<dt>
						<label>{L_DISPLAY_RESULTS}:</label>
					</dt>
					<dd>
						<label for="topics">
							<input id="topics" type="radio" name="show_results" value="topics" checked="checked" />{L_TOPICS}
						</label>
						<label for="posts">
							<input id="posts" type="radio" name="show_results" value="posts" />{L_POSTS}
						</label>
					</dd>
				</dl>
				<dl>
					...
					<dd>
						<select name="sort_by">{S_SORT_OPTIONS}</select>
					</dd>
					<dd class="dd-options">
						<label for="ASC">
							<input id="ASC" type="radio" name="sort_dir" value="ASC" />{L_SORT_ASCENDING}</label>
						<label for="DESC">
							<input id="DESC" type="radio" name="sort_dir" value="DESC" checked="checked" />{L_SORT_DESCENDING}
						</label>
					</dd>
				</dl>
			</fieldset>
