...
<section class="borderwrap clear">
	<form action="{S_PROFILE_ACTION}" {S_FORM_ENCTYPE} method="post" name="post" id="ucp" class="ipbform2 columned">
		...
		<div class="maintitle clearfix">
			<h3>{L_REGISTRATION_INFO}{L_MY_PROFILE}</h3>
		</div>
		...
		<div class="box-content profile">
			...
			<div class="subtitle cleared">
				<h3>{L_PROFILE_INFO}:</h3> {L_PROFILE_INFO_NOTICE}</div>
			<fieldset>
				<dl>
			...
			<div class="box-content profile">
				...
				<div class="box-content profile prefs">
					...
					<div class="maintitle">
						<h3>{L_AVATAR_PANEL}</h3>
					</div>
					<div class="subtitle">
						<p class="subtitled">{L_AVATAR_EXPLAIN}</p>
					</div>
